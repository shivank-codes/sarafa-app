...
const SHELL = [
  ...
  './js/catalog.js', './js/photo.js', './js/samples.js', './js/demo.js', './js/demo-seed.js', './js/install.js', './js/villages.js',
  ...
  './img/designs/rakhi.svg', './img/designs/mangalsutra.svg',
  ...
  './img/designs/photos/payal.jpg', './img/designs/photos/coin.jpg',
